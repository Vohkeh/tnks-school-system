  ...
  function buildClassResultsHTML(classStudents, className) {
    ...
    const rows=ranked.map((s,i)=>{
      ...
      return `<tr style="background:${i%2===0?"rgba(255,255,255,0.55)":"rgba(248,250,252,0.55)"}">
        ...
        <td style="padding:6px 8px;font-weight:bold;white-space:nowrap;min-width:150px;">${(s.name||"").trim()}</td>
    ...
    return `<div style="margin-bottom:32px;">
      ...
      <table class="results-table" style="width:100%;border-collapse:collapse;font-size:10px;min-width:600px;">
        <thead><tr style="background:#3b0764;">
          ...
          <th style="padding:5px 8px;text-align:left;color:white;min-width:150px;">Name</th>
          ${subs.map(s=>{const isComb=s===SCI_AGRI_COMBINED;const short=getSubShort(s);return`<th style="padding:0;min-width:36px;height:85px;vertical-align:bottom;background:${isComb?"#0d9488":"#3b0764"};position:relative;overflow:hidden;" title="${s}"><div style="position:absolute;bottom:10px;right:4px;transform:rotate(-45deg);transform-origin:right bottom;white-space:nowrap;font-size:11px;font-weight:bold;color:white;">${short}</div></th>`;}).join("")}
    ...
    return `<div style="margin-bottom:32px;">
      ...
      <table class="grade-table" style="width:100%;border-collapse:collapse;font-size:10px;min-width:600px;">
        <thead><tr style="background:#1d4ed8;">
          <th style="padding:5px 6px;text-align:center;color:white;">Pos</th>
          <th style="padding:5px 8px;text-align:left;color:white;min-width:150px;">Name</th>
          ${subs.map(s=>{const isComb=s===SCI_AGRI_COMBINED;const short=getSubShort(s);return`<th style="padding:0;min-width:36px;height:85px;vertical-align:bottom;background:${isComb?"#0d9488":"#1d4ed8"};position:relative;overflow:hidden;" title="${s}"><div style="position:absolute;bottom:10px;right:4px;transform:rotate(-45deg);transform-origin:right bottom;white-space:nowrap;font-size:11px;font-weight:bold;color:white;">${short}</div></th>`;}).join("")}
